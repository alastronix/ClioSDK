...
{
    /// <summary>
    /// Represents a ClioPaymentsPayments in the Clio API
    /// </summary>
    public class ClioPaymentsPayments : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ClioPaymentsPayments
    /// </summary>
    public class ClioPaymentsPaymentsRequest
    {
