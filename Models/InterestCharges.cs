...
{
    /// <summary>
    /// Represents a InterestCharges in the Clio API
    /// </summary>
    public class InterestCharges : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating InterestCharges
    /// </summary>
    public class InterestChargesRequest
    {
