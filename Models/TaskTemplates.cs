...
{
    /// <summary>
    /// Represents a TaskTemplates in the Clio API
    /// </summary>
    public class TaskTemplates : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating TaskTemplates
    /// </summary>
    public class TaskTemplatesRequest
    {
