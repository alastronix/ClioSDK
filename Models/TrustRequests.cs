...
{
    /// <summary>
    /// Represents a TrustRequests in the Clio API
    /// </summary>
    public class TrustRequests : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating TrustRequests
    /// </summary>
    public class TrustRequestsRequest
    {
