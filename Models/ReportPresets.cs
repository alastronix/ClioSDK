...
{
    /// <summary>
    /// Represents a ReportPresets in the Clio API
    /// </summary>
    public class ReportPresets : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ReportPresets
    /// </summary>
    public class ReportPresetsRequest
    {
