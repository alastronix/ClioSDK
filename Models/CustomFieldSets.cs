...
{
    /// <summary>
    /// Represents a CustomFieldSets in the Clio API
    /// </summary>
    public class CustomFieldSets : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CustomFieldSets
    /// </summary>
    public class CustomFieldSetsRequest
    {
