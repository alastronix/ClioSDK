...
{
    /// <summary>
    /// Represents a CivilControlledRates in the Clio API
    /// </summary>
    public class CivilControlledRates : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CivilControlledRates
    /// </summary>
    public class CivilControlledRatesRequest
    {
