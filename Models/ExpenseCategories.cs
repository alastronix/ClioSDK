...
{
    /// <summary>
    /// Represents a ExpenseCategories in the Clio API
    /// </summary>
    public class ExpenseCategories : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ExpenseCategories
    /// </summary>
    public class ExpenseCategoriesRequest
    {
