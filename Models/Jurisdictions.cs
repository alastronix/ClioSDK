...
{
    /// <summary>
    /// Represents a Jurisdictions in the Clio API
    /// </summary>
    public class Jurisdictions : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating Jurisdictions
    /// </summary>
    public class JurisdictionsRequest
    {
