...
{
    /// <summary>
    /// Represents a JurisdictionsToTriggers in the Clio API
    /// </summary>
    public class JurisdictionsToTriggers : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating JurisdictionsToTriggers
    /// </summary>
    public class JurisdictionsToTriggersRequest
    {
