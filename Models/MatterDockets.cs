...
{
    /// <summary>
    /// Represents a MatterDockets in the Clio API
    /// </summary>
    public class MatterDockets : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating MatterDockets
    /// </summary>
    public class MatterDocketsRequest
    {
