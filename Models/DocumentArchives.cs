...
{
    /// <summary>
    /// Represents a DocumentArchives in the Clio API
    /// </summary>
    public class DocumentArchives : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating DocumentArchives
    /// </summary>
    public class DocumentArchivesRequest
    {
