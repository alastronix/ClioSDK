...
{
    /// <summary>
    /// Represents a CalendarEntries in the Clio API
    /// </summary>
    public class CalendarEntries : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CalendarEntries
    /// </summary>
    public class CalendarEntriesRequest
    {
