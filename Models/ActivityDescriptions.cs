...
{
    /// <summary>
    /// Represents a ActivityDescriptions in the Clio API
    /// </summary>
    public class ActivityDescriptions : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ActivityDescriptions
    /// </summary>
    public class ActivityDescriptionsRequest
    {
