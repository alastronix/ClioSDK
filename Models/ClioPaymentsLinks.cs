...
{
    /// <summary>
    /// Represents a ClioPaymentsLinks in the Clio API
    /// </summary>
    public class ClioPaymentsLinks : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ClioPaymentsLinks
    /// </summary>
    public class ClioPaymentsLinksRequest
    {
