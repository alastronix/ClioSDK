...
{
    /// <summary>
    /// Represents a PracticeAreas in the Clio API
    /// </summary>
    public class PracticeAreas : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating PracticeAreas
    /// </summary>
    public class PracticeAreasRequest
    {
