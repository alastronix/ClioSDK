...
{
    /// <summary>
    /// Represents a RelatedContacts in the Clio API
    /// </summary>
    public class RelatedContacts : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating RelatedContacts
    /// </summary>
    public class RelatedContactsRequest
    {
