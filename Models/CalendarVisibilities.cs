...
{
    /// <summary>
    /// Represents a CalendarVisibilities in the Clio API
    /// </summary>
    public class CalendarVisibilities : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CalendarVisibilities
    /// </summary>
    public class CalendarVisibilitiesRequest
    {
