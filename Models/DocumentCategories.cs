...
{
    /// <summary>
    /// Represents a DocumentCategories in the Clio API
    /// </summary>
    public class DocumentCategories : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating DocumentCategories
    /// </summary>
    public class DocumentCategoriesRequest
    {
