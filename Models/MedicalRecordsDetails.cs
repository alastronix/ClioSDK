...
{
    /// <summary>
    /// Represents a MedicalRecordsDetails in the Clio API
    /// </summary>
    public class MedicalRecordsDetails : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating MedicalRecordsDetails
    /// </summary>
    public class MedicalRecordsDetailsRequest
    {
