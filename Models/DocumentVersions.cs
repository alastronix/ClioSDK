...
{
    /// <summary>
    /// Represents a DocumentVersions in the Clio API
    /// </summary>
    public class DocumentVersions : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating DocumentVersions
    /// </summary>
    public class DocumentVersionsRequest
    {
