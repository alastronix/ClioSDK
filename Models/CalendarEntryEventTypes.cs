...
{
    /// <summary>
    /// Represents a CalendarEntryEventTypes in the Clio API
    /// </summary>
    public class CalendarEntryEventTypes : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CalendarEntryEventTypes
    /// </summary>
    public class CalendarEntryEventTypesRequest
    {
