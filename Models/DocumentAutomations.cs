...
{
    /// <summary>
    /// Represents a DocumentAutomations in the Clio API
    /// </summary>
    public class DocumentAutomations : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating DocumentAutomations
    /// </summary>
    public class DocumentAutomationsRequest
    {
