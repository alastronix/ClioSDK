...
{
    /// <summary>
    /// Represents a MedicalBills in the Clio API
    /// </summary>
    public class MedicalBills : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating MedicalBills
    /// </summary>
    public class MedicalBillsRequest
    {
