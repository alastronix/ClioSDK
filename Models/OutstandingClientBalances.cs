...
{
    /// <summary>
    /// Represents a OutstandingClientBalances in the Clio API
    /// </summary>
    public class OutstandingClientBalances : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating OutstandingClientBalances
    /// </summary>
    public class OutstandingClientBalancesRequest
    {
