...
{
    /// <summary>
    /// Represents a TaskTemplateLists in the Clio API
    /// </summary>
    public class TaskTemplateLists : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating TaskTemplateLists
    /// </summary>
    public class TaskTemplateListsRequest
    {
