...
{
    /// <summary>
    /// Represents a ActivityRates in the Clio API
    /// </summary>
    public class ActivityRates : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ActivityRates
    /// </summary>
    public class ActivityRatesRequest
    {
