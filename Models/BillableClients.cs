...
{
    /// <summary>
    /// Represents a BillableClients in the Clio API
    /// </summary>
    public class BillableClients : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating BillableClients
    /// </summary>
    public class BillableClientsRequest
    {
