...
{
    /// <summary>
    /// Represents a CreditMemos in the Clio API
    /// </summary>
    public class CreditMemos : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating CreditMemos
    /// </summary>
    public class CreditMemosRequest
    {
