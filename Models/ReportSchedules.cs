...
{
    /// <summary>
    /// Represents a ReportSchedules in the Clio API
    /// </summary>
    public class ReportSchedules : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating ReportSchedules
    /// </summary>
    public class ReportSchedulesRequest
    {
