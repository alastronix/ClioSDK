...
{
    /// <summary>
    /// Represents a TrustLineItems in the Clio API
    /// </summary>
    public class TrustLineItems : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating TrustLineItems
    /// </summary>
    public class TrustLineItemsRequest
    {
