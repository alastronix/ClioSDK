...
{
    /// <summary>
    /// Represents a BankTransfers in the Clio API
    /// </summary>
    public class BankTransfers : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating BankTransfers
    /// </summary>
    public class BankTransfersRequest
    {
