...
{
    /// <summary>
    /// Represents a MatterStages in the Clio API
    /// </summary>
    public class MatterStages : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating MatterStages
    /// </summary>
    public class MatterStagesRequest
    {
