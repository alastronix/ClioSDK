...
{
    /// <summary>
    /// Represents a BillableMatters in the Clio API
    /// </summary>
    public class BillableMatters : BaseModel
    {
    ...
    /// <summary>
    /// Request model for creating/updating BillableMatters
    /// </summary>
    public class BillableMattersRequest
    {
