...
namespace ClioSDK.Clients
{
    ...
    public class RemindersClient : BaseClient
    {
        ...
        /// </summary>
        public async Task<ApiResponse<PaginatedResponse<Reminders>>> GetAsync(
            Dictionary<string, object> parameters = null)
        {
            return await GetAsync<PaginatedResponse<Reminders>>("reminders.json", parameters);
        }
        ...
        {
            return await GetAsync<Reminders>("reminders/{id}.json", id);
        }
        ...
        /// </summary>
        public async Task<ApiResponse<Reminders>> UpdateAsync(int id, RemindersRequest request)
        {
            return await UpdateAsync<RemindersRequest, Reminders>("reminders/{id}.json", id, request);
        }
