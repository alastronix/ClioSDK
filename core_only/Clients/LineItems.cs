...
public class LineItemsClient : BaseClient
{
    ...
    public async System.Threading.Tasks.Task<ApiResponse<LineItem>> CreateAsync(ClioSDK.Models.Requests.LineItemRequest request)
    {
        return await CreateAsync<ClioSDK.Models.Requests.LineItemRequest, LineItem>("", request);
    }

    public async System.Threading.Tasks.Task<ApiResponse<LineItem>> UpdateAsync(int id, ClioSDK.Models.Requests.LineItemRequest request)
    {
        return await UpdateAsync<ClioSDK.Models.Requests.LineItemRequest, LineItem>(id.ToString(), request);
    }
